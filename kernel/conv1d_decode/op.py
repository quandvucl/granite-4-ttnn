"""Host-side launcher for the conv1d_decode kernel (fused Mamba2 causal conv1d decode step)."""
...
def _make_runtime_args(
    plan, xBC_addr, cache_addr, w_addr, bias_addr, new_cache_addr, out_addr
):
