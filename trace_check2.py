"""Compare: trace vs no-trace with repetition penalty (same as bench)."""
import os, sys, time
...
def decode_20(prompt, use_trace=True):
    if not use_trace:
        tt_model._disable_trace = True
    else:
        tt_model._disable_trace = False
...
print("--- WITH TRACE ---")
print(decode_20(prompt, use_trace=True))
print("--- NO TRACE ---")
print(decode_20(prompt, use_trace=False))
